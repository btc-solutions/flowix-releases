...
flowix:
  ...
  javaPath: ""              # Optional. Full path to the 'bin' folder of the Java installation you want the plugin to use. 
...
![img](images/add_mock_vsc.png)

### Mock Editor

The Mock Editor dialog opens when you click an "Edit Mock" button.
...
2. For each column, specify:
   ...
   - **Data Type**: PostgreSQL data type (OID)
   - **Length**: Field length
